      ...
      <div className="space-y-6">
        ...
        {editingImage && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center z-50">
            <div className="bg-slate-800 border border-slate-600 rounded-t-xl sm:rounded-lg p-4 sm:p-6 w-full sm:max-w-2xl sm:mx-4 max-h-[90vh] sm:max-h-[80vh] overflow-y-auto">
