        ...
        <div className="space-y-6">
          ...
          <div className="text-center">
            <Image 
              ...
              width={80} 
              height={80}
              className="rounded-lg shadow-lg mx-auto mb-3"
            />
            <p className="text-dark-text-muted text-sm mb-6">AI Powered Social Automation</p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full btn btn-primary flex items-center justify-center gap-3 py-4 text-base"
          >
            {loading ? (
              <>
