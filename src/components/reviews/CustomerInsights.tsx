// src/components/reviews/CustomerInsights.tsx
'use client'
...
export default function CustomerInsights({ locations, reviews }: CustomerInsightsProps) {
    ...
    try {
      ...
      const response = await fetch('/api/ai/generate-customer-insights', {
        ...
        body: JSON.stringify({
          ...
          reviews: reviews // Send current reviews to analyze
        })
      })
